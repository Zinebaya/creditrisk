...
export type Prediction = { id: number; user_id?: number; client_id?: number; client_name?: string; user_email?: string; input_json?: Record<string, any>; prediction: string; probability: number; decision: string; explanation?: any; created_at: string }
